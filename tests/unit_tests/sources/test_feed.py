...
def test_discover_stops_at_cursor_and_advances_to_newest_item():
...
def test_discover_recovers_when_cursor_is_absent():
    connector = _connector(
        b"""<rss><channel>
        <item><guid>new</guid><link>https://example.com/new</link></item>
        <item><guid>old</guid><link>https://example.com/old</link></item>
...
def test_discover_rejects_unsafe_or_malformed_xml(content):
