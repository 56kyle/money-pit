...
def build_portfolio_runtime(
    *,
    ...
    policy = PortfolioPolicy(
        ...
        maximum_position_weight=strategy.name_weight_limit,
        maximum_satellite_weight=strategy.satellite_weight_limit,
        maximum_turnover=strategy.turnover_limit,
        minimum_trade_weight=0.0,
        maximum_position_change=strategy.position_change_limit,
        minimum_core_weights=strategy.strategic_core_targets,
